...
public class UserModiAndDelIFrame extends JInternalFrame {
	...
	private Object[][] getFileStates(List list){
		String[] str = { "用户编号", "用户姓名", "性别", "年龄", "身份证号", "工作日期",
				"电话", "密码" };
		Object[][]users=new Object[list.size()][str.length];
		for(int i=0;i<list.size();i++){
			User user=(User)list.get(i);
			users[i][0]=new Integer(user.getId());
			...
			users[i][2]=gender;
			users[i][3]=new Integer(user.getAge());
	...
	public UserModiAndDelIFrame() {
		...
		str = new String[]{"用户编号", "用户姓名", "性别", "年龄", "身份证号", "工作日期",
				"电话", "密码" };
