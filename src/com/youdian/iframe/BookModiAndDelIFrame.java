...
import com.youdian.jcompz.Item;
...
public class BookModiAndDelIFrame extends JInternalFrame {
	...
	private Object[][] getFileStates(List list){
		...
		for(int i=0;i<list.size();i++){
			...
			String booktypename=String.valueOf(MapPz.getMap().get(String.valueOf(bookinfo.getTypeId())));
			...
			results[i][6]=bookinfo.getPublish_date();
...
//		panel_1.add(button_2);
	...
	class addBookActionListener implements ActionListener {
		public void actionPerformed(final ActionEvent e) {
			...
			String bookTypes=String.valueOf(item.getId());
			...
			int i=Dao.Updatebook(ISBNs, Integer.parseInt(bookTypes), bookNames, writers, translators, publishers, pubDates, prices);
