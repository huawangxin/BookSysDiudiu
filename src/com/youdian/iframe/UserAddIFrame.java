...
public class UserAddIFrame extends JInternalFrame {
	...
	private JTextField textField_5;//用户添加功能的押金
	private JTextField textField_4;//用户添加功能的电话
	private JFormattedTextField textField_3;//用户添加功能的日期
	private JTextField textField_2;//用户添加功能的年龄
	private JTextField textField_1;//用户添加功能身份证号
	private JTextField textField;//用户添加功能的用户名
	private  JPasswordField textField_6;//用户添加功能的密码
	...
	public UserAddIFrame() {
		...
		button.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				int age=Integer.parseInt(textField_2.getText());//年龄
//				String identityCard = textField_1.getText();//身份证号
				String workDate=textField_3.getText();//日期
				String tel=textField_4.getText();//电话
				String identityCard=textField_5.getText();//学号
				String password=textField_6.getText();//密码
				String gender="1";
				
				if(!radioButton1.isSelected()){
					gender="2";
					}
				int i=Dao.Insertoperator(username,gender,age,identityCard,workDate,tel,password);
				if(i==1){
